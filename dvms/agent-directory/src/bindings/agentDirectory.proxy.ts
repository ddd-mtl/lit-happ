...
// @ts-ignore
import {AGENT_DIRECTORY_PATH, AgentDirectoryEntry, Stub, } from './agentDirectory.types';
// @ts-ignore
import {
/** api/common.ts */
// @ts-ignore
...
import {agentDirectoryFunctionNames} from './agentDirectory.fn';
import {AgentDirectoryUnitEnum} from './agentDirectory.integrity';
import {AgentDirectoryLinkType} from './agentDirectory.integrity';

/**
 *
 */
export class AgentDirectoryProxy extends ZomeProxy {
  static override readonly DEFAULT_ZOME_NAME = "agentDirectory";
