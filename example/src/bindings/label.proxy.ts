...
export class LabelProxy extends ZomeProxy {
  static override readonly DEFAULT_ZOME_NAME = "zLabel";
  static override readonly FN_NAMES = labelFunctionNames;
  static override readonly ENTRY_TYPES = Object.values(LabelUnitEnum);
  static override readonly LINK_TYPES = Object.values(LabelLinkType);
