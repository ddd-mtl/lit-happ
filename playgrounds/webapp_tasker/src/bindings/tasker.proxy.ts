...
// @ts-ignore
import {TaskerEntry, CreateTaskItemInput, GetAgentInput, GetAhInput, GetDataTypeInput, GetDhInput, GetEhInput, GetLhInput, GetManyAgentInput, GetManyAhInput, GetManyDhInput, GetManyEhInput, GetManyLhInput, MyValidationReceiptInfo, MyValidationReceiptSet, TaskItem, TaskList, } from './tasker.types';
// @ts-ignore
import {
/** api/common.ts */
// @ts-ignore
