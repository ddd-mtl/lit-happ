...
git clone -b "for-hdk-v0.3.0-beta-dev.33" --depth 1 https://github.com/holochain-open-dev/profiles

echo \* Download latest profiles-alt zome
git clone -b "hdk-3.0" --depth 1 https://github.com/ddd-mtl/profiles_alt_zome.git
