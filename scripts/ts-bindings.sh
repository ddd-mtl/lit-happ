...
zits --default-zome-name profiles -f "cast_tip" -f "synchronize_tip" -i submodules/profiles_alt_zome/crates/alt_coordinator -i submodules/profiles/crates/integrity -o packages/profiles-dvm/src/bindings/profilesAlt.ts

zits --default-zome-name zSharedOwnership -f "cast_tip" -f "synchronize_tip" -i submodules/profiles_alt_zome/crates/shared_ownership_coordinator -i submodules/profiles_alt_zome/crates/shared_ownership_integrity -o packages/shared-ownership-dvm/src/bindings/sharedOwnership.ts
