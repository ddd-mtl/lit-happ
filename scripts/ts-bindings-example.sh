...
zits --default-zome-name zTasker -i submodules/zdk/zomes/zome_core -i playgrounds/zomes/tasker -i playgrounds/zomes/tasker_model -o playgrounds/webapp/src/bindings/tasker.ts
